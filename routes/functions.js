...
var api = {
  ...
  e: { // entities
	...
	aid: { // appeals id
      ...
      st: { // statistics
	get: function (req, res) { // get all default statistics
	...
	put: function (req, res) { // edit statistics default settings, like get 1m, 3m or 2y or 30d
	  
	},
	delete: function (req, res) { // RESERVED
